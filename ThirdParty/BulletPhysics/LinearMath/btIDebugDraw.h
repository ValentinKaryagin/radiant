...
class	btIDebugDraw
{
	...
	virtual void drawTransform(const btTransform& transform, btScalar orthoLen)
	{
		...
		drawLine(start, start + transform.getBasis() * btVector3(orthoLen, 0.0f, 0.0f), btVector3(1.0f, 0.3f, 0.3f));
		drawLine(start, start + transform.getBasis() * btVector3(0.0f, orthoLen, 0.0f), btVector3(0.3f, 1.0f, 0.3f));
		drawLine(start, start + transform.getBasis() * btVector3(0.0f, 0.0f, orthoLen), btVector3(0.3f, 0.3f, 1.0f));
	}
